...
!(function () {
  ...
  function b() {
    var b = a(
      'div',
      'z-index:2147483647;font-family:Helvetica,Arial,sans-serif;font-size:12px;font-weight:bold;padding:10px;text-align:left;opacity:0.8;position:fixed;min-width:400px;max-height:70vh;overflow:auto;background:' +
        _options.bgColor +
        ';' +
        _options.css,
    );
  ...
  function c(b) {
    return function () {
      ...
      (c.textContent = d), o.appendChild(c), _options.autoScroll && (o.scrollTop = o.scrollHeight - o.clientHeight);
    };
  }
  function d() {
    o.innerHTML = '';
  ...
  function i(a) {
    for (var b in a) a.hasOwnProperty(b) && _options.hasOwnProperty(b) && (_options[b] = a[b]);
  }
  function j(a) {
    p ||
      ((p = !0),
  ...
  function n(a, b) {
    return function () {
      a.apply(this, arguments), 'function' == typeof q[b] && q[b].apply(console, arguments);
    };
  }
  var o,
    p = !1,
